    ...
    return (
      <div style={{ minHeight: '100vh', backgroundColor: '#f3f4f6', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '20px', fontFamily: 'sans-serif' }}>
        <div style={{ maxWidth: '400px', width: '100%', backgroundColor: 'white', borderRadius: '12px', boxShadow: '0 10px 25px rgba(0,0,0,0.1)', padding: '40px', textAlign: 'center' }}>
          ...
          <p style={{ color: '#4b5563', marginBottom: '30px' }}>Bem-vindo ao seu novo sistema de gestão.</p>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            <button style={{ width: '100%', padding: '12px', backgroundColor: 'white', color: '#2563eb', border: '1px solid #2563eb', borderRadius: '6px', fontWeight: '600', cursor: 'pointer' }}>Configurações</button>
          </div>
          <div style={{ marginTop: '25px', paddingTop: '20px', borderTop: '1px solid #e5e7eb' }}>
            <p style={{ fontSize: '12px', color: '#9ca3af' }}>Status do Servidor: <span style={{ color: status === 'Erro na conexão' ? '#ef4444' : '#10b981', fontWeight: 'bold' }}>{status}</span></p>
          </div>
        </div>
      </div>
    )
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f3f4f6', padding: '40px', fontFamily: 'sans-serif' }}>
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px' }}>
          ...
          <button onClick={() => setView('home')} style={{ padding: '8px 16px', backgroundColor: '#6b7280', color: 'white', border: 'none', borderRadius: '6px', cursor: 'pointer' }}>Voltar</button>
        </div>
        ...
        <div style={{ backgroundColor: 'white', borderRadius: '12px', boxShadow: '0 4px 6px rgba(0,0,0,0.05)', padding: '20px' }}>
          ...
          <button onClick={() => alert('Funcionalidade de adicionar em breve!')} style={{ marginTop: '20px', width: '100%', padding: '12px', backgroundColor: '#10b981', color: 'white', border: 'none', borderRadius: '6px', fontWeight: '600', cursor: 'pointer' }}>+ Novo Agendamento</button>
        </div>
      </div>
    </div>
  )
